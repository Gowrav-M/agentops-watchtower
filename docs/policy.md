...
Policy gates apply to scanner findings, report findings, MCP baseline drift findings, MCP config inventory findings, MCP admission findings, and runtime attack graph findings.
